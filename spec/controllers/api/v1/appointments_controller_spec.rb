...
RSpec.describe Api::V1::AppointmentsController, type: :controller do # rubocop:disable Metrics/BlockLength
  ...
  context 'when the user is not authenticated' do
    ...
    describe 'POST #create' do
      before do
        post :create,
             params: { appointment: { doctor_id: doctor&.id, appointment_date:, start_time: appointment_start_time } }
      end
      it_behaves_like 'an unauthenticated user'
    end
    ...
    describe 'PATCH #update' do
      before do
        patch :update, params: { id: appointment.id, appointment: { appointment_date:, start_time: } }
      end
      it_behaves_like 'an unauthenticated user'
    end
